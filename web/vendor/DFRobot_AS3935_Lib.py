...
'''
import time
import smbus2 as smbus   # trixie: python3-smbus gibt es nicht mehr, smbus2 ist API-kompatibel
...
class DFRobot_AS3935:
  ...
  def read_data(self, register):
    # smbus2 verlangt die Laenge; das alte smbus hatte 32 als Vorgabe.
    # Die Bibliothek benutzt ohnehin nur register[0] — 1 Byte ist das Richtige,
    # und der AS3935 hat gar keine 32 Register.
    self.register = self.i2cbus.read_i2c_block_data(self.address, register, 1)
